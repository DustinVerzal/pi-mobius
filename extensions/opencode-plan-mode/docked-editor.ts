...
import { Key, matchesKey, type Component, type OverlayHandle } from "@mariozechner/pi-tui";
import {
...
class WorkflowRailOverlay implements Component {
  ...
  render(width: number): string[] {
    ...
    return renderPlanSidebar(this.model, this.theme, width);
  }
}
...
export class DockedPlanModeEditor extends CustomEditor {
  ...
  constructor(
    ...
    this.railOverlay = new WorkflowRailOverlay(sidebarTheme);
  }
